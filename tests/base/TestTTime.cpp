...
TEST(TestTTime, NowMS_ReturnsCurrentTime)
{
...
TEST(TestTTime, Now_ReturnsCurrentTime)
{
...
TEST(TestTTime, NowWithParams_ReturnsCurrentTimeAndSetsParams)
{
    int year, month, day, hour, minute, second;
    int64_t time = TTime::Now(year, month, day, hour, minute, second);

    std::cout << "当前时间: " << year << "-" << month << "-" << day << " " << hour << ":" << minute
              << ":" << second << std::endl;
...
TEST(TestTTime, ISOTime_ReturnsValidISO8601Format)
{
